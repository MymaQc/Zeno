...
class Gadgets
{
    ...
    public function createevent($pl)
    {
        $form = $this -> createSimpleForm(function (Player $pl, int $data = null) {
            $result = $data;
            if ($result === null) {
            ...
            switch ($result) {
                case 0:
                    if ($pl -> hasPermission("create.nodebuff")) {
                        $pl -> sendMessage("NTM");
                    } else {
                        $pl -> sendMessage("§l§a» §r§cYou do not have permission to create an event !");
                    }
                    break;
                case 1:
                    if ($pl -> hasPermission("create.sumo")) {
                        $pl -> sendMessage("NTM2");
                    } else {
                        $pl -> sendMessage("§l§a» §r§cYou do not have permission to create an event !");
                    }
